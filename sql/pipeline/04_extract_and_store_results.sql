...
SELECT
  ...
  R.RAW_EXTRACTION_RESPONSE:response:fee_schedule:procedure_code AS PROCEDURE_CODE_ARRAY,
  R.RAW_EXTRACTION_RESPONSE:response:fee_schedule:modifier AS MODIFIER_ARRAY,
  R.RAW_EXTRACTION_RESPONSE:response:fee_schedule:medicaid_fee AS MEDICAID_FEE_ARRAY,
